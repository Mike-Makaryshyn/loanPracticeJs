...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.colored .play', '.overlay').init();
...
function () {
  ...
  _createClass(Difference, [{
    key: "showAndAnimateItems",
    value: function showAndAnimateItems(items, counter) {
    ...
    value: function bindTriggers(container, items, counter) {
      ...
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== items.length - 2) {
          _this.showAndAnimateItems(items, counter);
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    key: "bindCloseBtnAndModal",
    value: function bindCloseBtnAndModal() {
      var _this2 = this;
